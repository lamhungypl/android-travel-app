...
//     * @param context
//     */
//    public CustomClock(Context context, boolean defaultWatchFace) {
//        super(context);
//        if (defaultWatchFace)
//            init(context);
//    }
...
//        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.CustomClock, 0, 0);
//        if (typedArray.hasValue(R.styleable.CustomClock_default_watchface)) {
//            if (!typedArray.getBoolean(R.styleable.CustomClock_default_watchface, true)) {
//                typedArray.recycle();
//                return;
//            }
//        }
...
//        init(context, R.drawable.clock_face, R.drawable.clock_hours_hand,
//                R.drawable.clock_minutes_hand, 0, false, false);
//    }
//
//    /**
...
//        CustomClock.is24 = is24;
//
//        CustomClock.hourOnTop = hourOnTop;
//        setFace(watchFace);
...
//        invalidate();
//        if (mAutoUpdate) {
//            new Handler().postDelayed(() -> setTime(Calendar.getInstance()), 5000);
//        }
//    }
//
//    /**
