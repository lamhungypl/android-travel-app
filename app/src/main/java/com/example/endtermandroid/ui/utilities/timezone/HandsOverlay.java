...
//     * The scales of the minute hand and hour hand depends on the setScale function from CustomClock.java
//     *
//     * @param scale
//     * @return
//     */
...
//        return CustomClock.is24 ? ((12 + h) / 24.0f * 360) % 360 + (m / 60.0f) * 360 / 24.0f :
